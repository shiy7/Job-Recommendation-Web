(function() {
 ...
 // add event listeners for nearby, favorite, and recommendation
  ...
  // Add location info when session is valid
  ...
  function onPositionUpdated(position) {
	// if not comment, location can be update
	// commented because current location cannot find any job
